...
module.exports = (port, callback) => {
  ...
  // try 10 continuous ports in total
...
/**
 * Listen and close immediatly whether success or not
 * @param {*} port 
 * @param {*} hostname 
 * @param {*} callback 
 */
